...
<<<<<<< HEAD
    <div class="py-6 ...">
      <nav class="px-2 bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="container flex flex-wrap justify-between px-1 items-center mx-auto">
...
=======
    <div className="py-6 ...">
      <nav className="px-2 bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div className="container flex flex-wrap justify-between px-1 items-center mx-auto">
